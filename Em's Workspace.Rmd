...
```{r}
trips_plot <- trip_times %>% ggplot(aes(x = row_num, y = trip_length, color = factor(gender))) + geom_point() + xlab("Trip Number") + ylab("Trip Length in Minutes") + scale_color_discrete(name = "Gender") + ylim(c(0,65))
