...
```{r}
trips_plot <- trip_times %>% ggplot(aes(x = gender, y = trip_length, fill = gender )) + geom_boxplot() + ylab("Trip Length in Minutes") + xlab("Gender") +ylim(c(0,65)) + scale_fill_discrete(name="Gender",
                         breaks=c("0", "1"),
